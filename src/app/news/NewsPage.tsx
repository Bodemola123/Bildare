  ...
  return (
    <div className='flex flex-col gap-20 w-full bg-transparent text-white md:flex-grow md:overflow-y-auto h-full px-5 lg:px-[210px] md:px-[100px] py-[52px] scrollbar-hide relative'>
        <div className='flex justify-between items-center'>
            ...
            <button className='bg-[#B9F500] md:px-[18px] md:py-[11px] px-2.5 py-1.5 text-[#000000] font-semibold text-base rounded-2xl flex items-center justify-center'>Get Started</button>
        </div>
